...
type ICompanyDo interface {
	...
	FilterWithNameAndRole(name string, role string) (result []model.Company, err error)
}

// SELECT * FROM @@table WHERE name = @name{{if role !=""}} AND role = @role{{end}}
func (c companyDo) FilterWithNameAndRole(name string, role string) (result []model.Company, err error) {
...
func (c companyDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) ICompanyDo {
